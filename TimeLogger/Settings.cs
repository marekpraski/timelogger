...
namespace TimeLogger
{
    ...
    public class Settings
    {
        ...
        public static int buttonHeigth = 25;

        //rozlokowanie buttonów w groupboxie
        public static int firstButtonVerticalOffset = 15;
        public static int horizontalButtonPadding = 6;
        public static int verticalButtonPadding = 5;

        //rozlokowanie groupboxów
        public static int firstGroupboxVerticalLocation = 0;
        public static int horizontalGroupboxPadding = 5;
